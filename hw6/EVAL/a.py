...
def CDF(client_report, imgop):
    ...
    plt.ylabel('CDF')
    plt.legend()
    plt.title(f'({imgop}) CDF of Response Times')
    plt.grid(True)
    plt.show()


CDF(run1, 'IMG_REGISTER')
CDF(run1, 'IMG_ROT90CLKW')
CDF(run1, 'IMG_BLUR')
CDF(run1, 'IMG_SHARPEN')
CDF(run1, 'IMG_VERTEDGES')
CDF(run1, 'IMG_HORIZEDGES')

CDF(run2, 'IMG_REGISTER')
CDF(run2, 'IMG_ROT90CLKW')
CDF(run2, 'IMG_BLUR')
CDF(run2, 'IMG_SHARPEN')
CDF(run2, 'IMG_VERTEDGES')
CDF(run2, 'IMG_HORIZEDGES')

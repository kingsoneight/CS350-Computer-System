...
for ((i = 1; i <= 10; i++)); do
    ...
    /usr/bin/time -v ./hw6_sol/build/server_mimg -q 1500 -w 10 -p FIFO 2222 > ./hw6_sol/build/data/s_c${i}.txt & ./client 2222 -I ./images/ -L "${SCRIPT}" > ./hw6_sol/build/data/c_c${i}.txt

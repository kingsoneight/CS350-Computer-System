...
for i in $(seq 1 10); do
    ...
    Script="${Script}${Outro}"
    /usr/bin/time -v ./hw6_sol/build/server_mimg > ./hw6_sol/data/s_c${i}.txt -q 1500 -w 10 -p FIFO 2000 & 
    SERVER_PID=$!
    ./hw6_sol/hw7_client_and_images/client > ./hw6_sol/build/c_c${i}.txt 2000 -I ./hw6_sol/hw7_client_and_images/images/ -L ${Script}
    kill $SERVER_PID
done
# for i in $(seq 3 3); do
#     Script="${Intro}"
